...
from src.core.admin_reports.application.use_cases.create_admin_reports import (
    CreateAdminReports,
)
...
from src.entrypoints.web.v1.dependencies import (
    factory_admin_report_repository,
...
async def admin(
    ...
    return AdminReportsResponse(message="Hello, admin!", data=output if output else {})
