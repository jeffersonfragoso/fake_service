...
from src.core.user_purchases.application.use_cases.create_user_purchases import (
    CreateUserPurchases,
)
...
from src.entrypoints.web.api_exceptions import (
    ApiForbiddenException,
    ApiInternalServerException,
)
from src.entrypoints.web.v1.dependencies import (
    factory_user_purchase_repository,
...
async def get(
    ...
    return UserPurchasesResponse(message="Hello, user!", data=output if output else {})
