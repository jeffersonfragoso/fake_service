...
class TestAdminReportEntity:
    def test_name_cannot_be_empty(self):
        ...
        with pytest.raises(ValueError) as exc_info:
            AdminReportEntity(name=None, email="admin@example.com", reports=[{}])
    ...
    def test_email_cannot_be_empty(self):
        ...
        """
        with pytest.raises(ValueError) as exc_info:
            AdminReportEntity(name="Admin Master", email=None, reports=[{}])
    ...
    def test_reports_cannot_be_empty(self):
        ...
        """
        with pytest.raises(ValueError) as exc_info:
            AdminReportEntity(name="Admin Master", email="admin@example.com", reports=None)
